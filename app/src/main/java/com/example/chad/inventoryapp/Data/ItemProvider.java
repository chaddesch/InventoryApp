...
public class ItemProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.example.chad.inventoryapp/items" will map to the
        ...
        // For example, "content://com.example.chad.inventoryapp/items/3" matches, but
        // "content://com.example.chad.inventoryapp/items" (without a number at the end) doesn't match.
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case ITEM_ID:
                ...
                // For an example URI such as "content://com.example.chad.inventoryapp/items/3",
    ...
    private Uri insertItem(Uri uri, ContentValues values) {
        ...
        // Makes sure a supplier name is provided
        ...
        // Make sure a supplier email is provided
    ...
    private int updateItem(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // Make sure supplier email is provided
